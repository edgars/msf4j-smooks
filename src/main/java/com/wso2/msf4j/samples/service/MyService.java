...
import org.wso2.msf4j.internal.router.beanconversion.JsonConverter;
...
public class MyService {
    ...
    public Response postConvertionFromSmooks( @QueryParam("edi") String edi)  {
    	
       String response = new EDIFactParser().parse(edi);
